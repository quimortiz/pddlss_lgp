...
other_table (table){ joint:rigid, shape:ssBox, Q:[0 .2 .035 1 0 0 0], size:[.3 .3 .04 .01], color:[.9 .1 .1] }

goal_table (table){ joint:rigid, shape:ssBox, Q:[0.4 .2 .035 1 0 0 0], size:[.12 .12 .04 .01], color:[.9 .1 .1] }

block1_ref (table){ joint:rigid, shape:ssBox, Q:[.8 0. .095 1 0 0 1], size:[.06 .15 .09 .01], color:[.6 .6 .8 .2] }

block2_ref (table){ joint:rigid, shape:ssBox, Q:[.4 .15 .095 1 0 0 1], size:[.06 .15 .09 .01], color:[.8 .6 .8 .2] }

block3_ref (table){ joint:rigid, shape:ssBox, Q:[.4 .26 .095 1 0 0 1], size:[.06 .15 .09 .01], color:[.8 .6 .8 .2] }



block4_ref (table){ joint:rigid, shape:ssBox, Q:[.8 .4 .095 1 0 0 1], size:[.06 .15 .09 .01], color:[.8 .6 .8 .2] }
...
block3(block3_ref){ joint:free, shape:ssBox, size:[.06 .15 .09 .01], color:[.8 .6 .8] }
block4(block4_ref){ joint:free, shape:ssBox, size:[.06 .15 .09 .01], color:[.8 .6 .8] }
...
f4_rand(goal_table) { shape:marker , Q:<t(0.0 0.01 0.1) d(0.5 0 0 1)> ,  size:[.1] }
...
f_block3_col(block3){  shape:ssBox, size:[.1 .19 .09 .01], color:[.8 .6 .8, .5] }
f_block4_col(block4){  shape:ssBox, size:[.1 .19 .09 .01], color:[.8 .6 .8, .5] }
