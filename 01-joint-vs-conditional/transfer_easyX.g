...
col_r_gripper(r_gripper) { shape:capsule, Q:[0 0 0.26 1 0 0 0 ],  size:[.3, .08], color:[1,0,0,.5]}
col_l_gripper(l_gripper) { shape:capsule, Q:[0 0 0.26 1 0 0 0 ],  size:[.3, .08], color:[1,0,0,.5]}
...
# goal1_table (table){ joint:rigid, shape:ssBox, Q:[.6 .2 .035 1 0 0 0], size:[.9 .7 .04 .01], color:[.1 .9 .1] }
...
# block1(block1_ref){ joint:free, shape:ssBox, size:[.06 .3 .09 .01], color:[.6 .6 .8] }
