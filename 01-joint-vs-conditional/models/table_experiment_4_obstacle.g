...
obs_1(goal_table) {
joint:rigid, shape:ssBox, Q:[.0 0. .065 1 0 0 1], size:[.1 .1 .09 .01], color:[.6 .6 .6 1] 
}
...
block3_ref (table){ joint:rigid, shape:ssBox, Q:[.0 0. .095 1 0 0 1], size:[.06 .15 .09 .01], color:[.6 .6 .8 .2] }

block4_ref (table){ joint:rigid, shape:ssBox, Q:[.0 .2 .095 1 0 0 1], size:[.06 .15 .09 .01], color:[.6 .6 .8 .2] }

block3(block3_ref){ joint:free, shape:ssBox, size:[.06 .15 .09 .01], color:[.6 .6 .8] }
block4(block4_ref){ joint:free, shape:ssBox, size:[.06 .15 .09 .01], color:[.8 .6 .8] }


fobs(obs_1){ shape:marker,size:[.1]}
...
f3_rand(goal_table) { shape:marker , Q:<t(0.01 0 0.1) d(-0.5 0 0 1)> , size:[.1] }
...
f_block3_col(block3){  shape:ssBox, size:[.1 .19 .09 .01], color:[.6 .6 .8, .5] }
